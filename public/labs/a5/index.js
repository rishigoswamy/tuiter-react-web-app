...
console.log("Arrays");
const constantArrayLength = numberArray1.length + stringArray1.length;
console.log("("+ numberArray1.length+ ")" + "["+numberArray1+"]");
console.log("("+ stringArray1.length+ ")" + "["+stringArray1+"]");
console.log( "[" + stringArray1.length+ ", " + numberArray1.length+ ", "+ constantArrayLength +", " +"Array("
    +numberArray1.length+"), " + "Array("+stringArray1.length+")]");
